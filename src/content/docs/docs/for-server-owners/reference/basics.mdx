...
import beerNameExcellent from "@/assets/docs/for-server-owners/reference/basics/beer-name-excellent.png";
import beerNameGood from "@/assets/docs/for-server-owners/reference/basics/beer-name-good.png";
import beerNameBad from "@/assets/docs/for-server-owners/reference/basics/beer-name-bad.png";
...
```
<Aside title="Yaml and '#'">Note that every ingredient group has to be within quotes, otherwise it would count as a comment due to the `#` symbol</Aside>
