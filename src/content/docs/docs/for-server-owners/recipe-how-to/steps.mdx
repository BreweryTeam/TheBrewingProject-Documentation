...
<Aside title="Initial Step">Cooking and mixing always have to be the first step of any brewing process!</Aside>
...
```
<Aside title="Ingredients">See [Ingredients Basics](../../reference/basics/#ingredients) for more information about the ingredient format</Aside>
...
<Aside title="Barrel Types">More about barrel types can be found in [Aging guide](/docs/for-players/brewing/aging/#barrel-types)</Aside>
