...
- `Java 21+`
- `PaperMC 1.21.8+` (or any compatible fork like Purpur), SpigotMC will not work

<Aside title="Folia" variant="error">

Folia is **NOT** supported by TheBrewingProject (yet).

There's an effort to make it compatible. If you're interested in helping, check [TheBrewingProject#77](https://github.com/BreweryTeam/TheBrewingProject/pull/77)
...
<Aside title="Problems?" variant="info">
