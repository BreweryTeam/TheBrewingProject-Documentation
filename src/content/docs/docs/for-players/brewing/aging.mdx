...
import smallBarrel from "@/assets/docs/for-players/guides/brewing/aging/small-barrel.webp";
import largeBarrel from "@/assets/docs/for-players/guides/brewing/aging/large-barrel.webp";
...
<Image src={largeBarrel} alt="Large barrel" />
