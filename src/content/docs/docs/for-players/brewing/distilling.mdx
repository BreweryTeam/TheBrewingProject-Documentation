...
import buildingADistilleryVideo from "@/assets/docs/for-players/guides/brewing/distilling/building-a-distillery.mp4";
import distilleryInputsAndOutputsImage from "@/assets/docs/for-players/guides/brewing/distilling/distillery-inputs-and-outputs.png";
import usingADistilleryVideo from "@/assets/docs/for-players/guides/brewing/distilling/using-a-distillery.webm";
